...
#define CSR_AUDVID_WB_TILESCONTROLREGISTERCSR_SIZE 2
static inline unsigned short int AudVid_WB_TilesControlRegisterCSR_read(void) {
	unsigned short int r = csr_readl(0xe0004000);
	r <<= 8;
	r |= csr_readl(0xe0004004);
	return r;
}
static inline void AudVid_WB_TilesControlRegisterCSR_write(unsigned short int value) {
